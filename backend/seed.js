...
const seedDB = async () => {
  ...
  if (!url) {
    console.error("MONGO_URL not defined in environmental variables.");
    process.exit(1);
  }
  ...
  try {
    ...
    // Clean holdings
    console.log("Clearing holdings...");
    await HoldingsModel.deleteMany({});
    console.log("Inserting seed holdings...");
    await HoldingsModel.insertMany(holdingsData);

    // Clean positions
    console.log("Clearing positions...");
    await PositionsModel.deleteMany({});
    console.log("Inserting seed positions...");
